...
class SettlementProcessor:
    ...
    def calculate_off_grid_lcoes(self, mg_hydro_calc, mg_wind_calc, mg_pv_calc, sa_pv_calc, mg_diesel_calc,
        ...
        if diesel_techs == 0:
            ...
            self.df[SET_LCOE_MG_DIESEL + "{}".format(year)] = \
            ...
            self.df[SET_LCOE_SA_DIESEL + "{}".format(year)] = \
        ...
        self.df[SET_LCOE_SA_PV + "{}".format(year)] = \
