    ...
    def pv_diesel_capacities(pv_capacity, battery_size, diesel_capacity, pv_no, diesel_no, battery_no):
        ...
        for i in range(8760):
            def calc_net_load(soc):
                ...
                return battery_use, soc, net_load

            battery_use[hour_numbers[i], :, :], soc, net_load = calc_net_load(soc)

            def battery_dispatchable():
            ...
            battery_dispatchable, battery_chargeable = battery_dispatchable()
            ...
            def fuel_and_final_load(fuel_result, annual_diesel_gen, net_load):
                ...
                return fuel_result, annual_diesel_gen, net_load

            fuel_result, annual_diesel_gen, net_load = fuel_and_final_load(fuel_result, annual_diesel_gen, net_load)

            def battery_use_calc(soc, unmet_demand, excess_gen, battery_use):
                ...
                return soc, unmet_demand, excess_gen, battery_use

            soc, unmet_demand, excess_gen, battery_use = battery_use_calc(soc, unmet_demand, excess_gen,  battery_use)

            def battery_life_calc(battery_life):
            ...
            battery_life_calc(battery_life)
