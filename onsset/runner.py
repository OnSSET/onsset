...
def scenario(specs_path, calibrated_csv_path, results_folder, summary_folder, general_specs):
    ...
    general_parameters = pd.read_excel(general_specs, sheet_name='ScenarioParameters')
                ...
                for discount in discount_rate:
                    for dem in demand:
                        for option in grid_options:
                            ...
                            prioritization = general_parameters.iloc[option]['PrioritizationAlgorithm']
                            auto_intensification = general_parameters.iloc[option]['AutoIntensificationKM']
                            end_year_pop = general_parameters.iloc[pop]['PopEndYear']
                            ...
                            settlements_out_csv = os.path.join(results_folder,
                                                               '{}-1-{}_{}_{}_{}_{}_{}.csv'.format(country_id, pop, dem,
                                                                                                   discount, grid, pv,
                                                                                                   option))
                            summary_csv = os.path.join(summary_folder,
                                                       '{}-1-{}_{}_{}_{}_{}_{}_summary.csv'.format(country_id, country_id, pop, dem,
                                                                                                   discount, grid, pv,
                                                                                                   option))
