...
specs_path = r'C:\Users\asahl\OneDrive - KTH\2022 IRENA electricity access\03 Pilot phase\Mockup runs\Senegal\inputs\sn-2-specs.xlsx'  #filedialog.askopenfilename()
...
if choice == 1:
    ...
    calibrated_csv_path = r'C:\Users\asahl\OneDrive - KTH\2022 IRENA electricity access\03 Pilot phase\Mockup runs\Senegal\inputs\sn-2-country-inputs.csv'  #filedialog.askopenfilename()
    # messagebox.showinfo('OnSSET', 'Browse to RESULTS folder to save outputs')
    results_folder = r'C:\Users\asahl\OneDrive - KTH\2022 IRENA electricity access\03 Pilot phase\Mockup runs\Senegal\inputs\PSO_test' #filedialog.askdirectory()
    #messagebox.showinfo('OnSSET', 'Browse to SUMMARIES folder and name the scenario to save outputs')
    summary_folder = r'C:\Users\asahl\OneDrive - KTH\2022 IRENA electricity access\03 Pilot phase\Mockup runs\Senegal\inputs\PSO_test'  #filedialog.askdirectory()
    pv_path = r'C:\Users\asahl\OneDrive - KTH\2022 IRENA electricity access\03 Pilot phase\Mockup runs\Senegal\inputs\sn-2-pv.csv'
