...
if choice == 1:
    ...
    wb_tier = int(input('World Bank Tiers of Electricity Access\n'
                      '1: {} kWh/hh/year\n2: {} kWh/hh/year\n3: {} kWh/hh/year\n4: {} kWh/hh/year\n5: {} kWh/hh/year\n'
                      'Enter the tier number: '.format(wb_tiers_all[1], wb_tiers_all[2], wb_tiers_all[3],
    ...
    for country in countries:
        ...
        grid_lcoes = get_grid_lcoe_table(energy_per_hh, max_dist, num_people_per_hh, transmission_losses,
                                                grid_base_to_peak, grid_price, grid_capacity_investment, grid_vals)
        df = techs_only(df, diesel_price, energy_per_hh, num_people_per_hh, mg_vals, mg_hydro_vals, mg_pv_vals,
                             mg_wind_vals, mg_diesel_vals, sa_pv_vals, sa_diesel_vals)
        df = run_elec(df, grid_lcoes, grid_price, existing_grid_cost_ratio, max_dist)
        df = results_columns(df, energy_per_hh, grid_base_to_peak, num_people_per_hh, diesel_price, grid_price,
